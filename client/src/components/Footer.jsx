        ...
        <div className="container">
            <div className="lg:grid lg:grid-cols-2">
                <div className="mb-10">
                    ...
                    <ButtonPrimary
                        href="mailto:contact@ahmadsaghir.tech"
                        label="Start project"
                        icon="chevron_right"
                        classes="reveal-up"
                    />
            ...
            <div className="flex items-center justify-between pt-10 mb-8">
                ...
                <p className="text-[rgb(var(--zinc50))]0 text-sm reveal-up">&copy; 2025 
                  <span className="text-[rgb(var(--zinc200))]"> Ahmad Saghir</span>
                </p>
            </div>                 
        </div>
    </footer>
