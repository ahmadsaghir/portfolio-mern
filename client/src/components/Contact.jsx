...
const socialLinks = [
    ...
    {
        href: 'https://www.linkedin.com/in/ahmad-saghir/',
        icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <section id="contact" className="section">
            <div className="container lg:grid lg:grid-cols-2">
                <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                    ...
                    <p className="text-[rgb(var(--zinc400))] mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
                ...
                <form 
                    action="https://getform.io/f/bdrrvqgb"
                    method="POST" 
                    ...
                    <div className="mb-4">
                            ...
                            <textarea 
                                name="message" 
                                id="message" 
                                placeholder="Share your ideas or collaboration proposal here... We'd reveal-up to hear from you!"
                                required
